...
<?php foreach($data as $val){ ?>
	<ul>
		   ...
		   <li>
		   	 商品图片: <a href="<?php echo $viewPath.$val['goods_img']?>" data-lightbox="light" data-title="<?=$val['goods_name'] ?>"><img src="<?php echo $viewPath.$val['goods_thumb']?>"></a>
		   </li>
		   <li>
		   	操作：<a href="<?=U('edit',array('id'=>$val['id']))?>">编辑</a>
		          <a href="<?=U('del',array('id'=>$val['id']))?>" onclick="return confirm('确定删除么？？')">删除</a>
		   </li>
